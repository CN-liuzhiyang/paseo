...
| Outbound channel          | `server.registerChannel`                         | Post each scheduled run's result to an outside service, such as a chat room, via the schedule's `delivery`    | reference.md → Outbound channels                                                                   |
