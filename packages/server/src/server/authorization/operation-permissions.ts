...
const INBOUND_PERMISSION = {
  ...
  "checkout.commits.files.request": "workspace.read",
  ...
  "schedule/channels": "automation.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "checkout.commits.files.response": "workspace.read",
  ...
  rpc_error: null,
  "schedule/channels/response": "automation.manage",
